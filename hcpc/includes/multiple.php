...
?>
	...
	<div>	
		<label>
			...
			<select name="What are your symptoms?" required="required" title="How You Heard is required" tabindex="30">
	...
	<div>	
		<fieldset>
			<legend>What are you  symptoms?</legend>
			<input type="checkbox" name="Interested_In[]" value="Chronic Pain" tabindex="40" /> Chronic Pain <br />
			<input type="checkbox" name="Interested_In[]" value="Paralyzed" /> Paralyzed <br />
			<input type="checkbox" name="Interested_In[]" value="Terminally Ill" /> Terminally Ill <br />
			<input type="checkbox" name="Interested_In[]" value="Elderly" /> Elderly <br />
            <input type="checkbox" name="Interested_In[]" value="Dimentia/Alzheimers" /> Dimentia/Alzheimeirs <br />
